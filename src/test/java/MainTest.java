...
public class MainTest {
    ...
    @RepeatedTest(10)
    public void testDialogueOrder() throws InterruptedException {
        ...
        Thread chandlerThread = new Thread(new CharacterRunnable("Chandler", scene, semaphore, dialogueOrder));
        Thread phoebeThread = new Thread(new CharacterRunnable("Phoebe", scene, semaphore, dialogueOrder));
        Thread monicaThread = new Thread(new CharacterRunnable("Monica", scene, semaphore, dialogueOrder));
        Thread rachelThread = new Thread(new CharacterRunnable("Rachel", scene, semaphore, dialogueOrder));
    ...
    static class CharacterRunnable implements Runnable {
        ...
        private List<String> dialogueOrder;

        public CharacterRunnable(String character, Scene scene, Semaphore semaphore, List<String> dialogueOrder) {
